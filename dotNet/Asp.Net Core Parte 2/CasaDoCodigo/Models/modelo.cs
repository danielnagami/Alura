...
namespace CasaDoCodigo.Models
{
    ...
    public class Cadastro : BaseModel
    {
        ...
        [Required(ErrorMessage = "Nome é obrigatório"), MinLength(5, ErrorMessage = "Nome deve ter no mínimo 5 caracteres"), MaxLength(50, ErrorMessage = "Nome deve ter no máximo 50 caracteres")]
